...
/**
 * This class is an array-based heap tree. 
 * This class is from the Chapter 21.4 Priority Queues in the book 
 * Starting Out with Java 4th Edition From Control Structures 
 * through Data Structures.
 */
public class ArrayHeapTree
{
  private ArrayList<Integer> arrayHeap = new ArrayList<Integer>();
